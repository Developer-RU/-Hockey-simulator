...
int trainingTime = 10;                     //  Продолжительность тренировки текущая
int durationTime = 1;                      //  Время сложности (длительности включения зоны)
int selectTime = 10;                       //  Выбранная продолжительность тренировки
        ...
        {               
            ...
            if(statusTraining)
            {
                ...
                else  //  Если время тренировки не прошло
                {
                    ...
                    if( currentTime >= (zoneStartTime + (durationTime*995)) && statusZones[currentZone] == 1)
                    {                        
                        //  Обнуляем текущую зону
                        statusZones[currentZone] = 0;
